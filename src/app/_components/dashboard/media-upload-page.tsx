...
export const MediaUploadPage: React.FC<MediaUploadPageProps> = ({
  ...
  return (
    <div className="flex flex-col lg:flex-row h-full">
      {/* Upload Form */}
      <div className="flex-1 p-4 sm:p-6 overflow-y-auto lg:border-r border-rose-200">
        ...
        <div className="flex gap-4 mb-6">
          <Button
            ...
            className={`flex items-center gap-2 px-6 py-3 rounded-full font-semibold ${uploadType === "image"
          ...
          <Button
            ...
            className={`flex items-center gap-2 px-6 py-3 rounded-full font-semibold ${uploadType === "video"
              ? "bg-gradient-to-r from-rose-500 to-pink-500 text-white shadow-lg"
              : "bg-white text-gray-700 border-2 border-rose-200 hover:border-rose-300 hover:bg-rose-50"
              }`}
          >
