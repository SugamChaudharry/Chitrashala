...
import { Home, Upload, Compass, Info, Contact, LogIn, LayoutDashboard } from "lucide-react";
...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside
      className={`hidden lg:block fixed h-[calc(100vh-4rem)] bg-white dark:bg-neutral-900 transition-all duration-300 z-40
